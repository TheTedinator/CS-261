...
int main(int argc, char* argv[]){
	...
	assertTrue(!containsDynArr(dyn, 3), "Test not containing 3");
        ...
        pushDynArr(dyn, 7);
        printf("\n\nSome additional bag testing...\n");
        printf("The bag's contents: [6,5,9]\n");
        printf("Pushing 7...\nThe bag's contents: [7,6,5,9]\n");
        assertTrue(containsDynArr(dyn, 7), "Test containing 7");
        assertTrue(sizeDynArr(dyn) == 4, "Test size = 4");
        removeDynArr(dyn, 5);
        printf("Removing 5...\nThe bag's contents: [7,6,9]\n");
        assertTrue(!containsDynArr(dyn, 5), "Test not containing 5");
        assertTrue(sizeDynArr(dyn) == 3, "Test size = 3");
        pushDynArr(dyn, 5);
        printf("Pushing 5...\nThe bag's contents: [5,7,6,9]\n");
        assertTrue(containsDynArr(dyn, 5), "Test containing 5");
        assertTrue(sizeDynArr(dyn) == 4, "Test size = 4");
        removeDynArr(dyn, 6);
        printf("Removing 6...\nThe bag's contents: [5,7,9]\n");
