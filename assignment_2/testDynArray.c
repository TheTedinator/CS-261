...
int main(int argc, char* argv[]){
    ...
    removeDynArr(dyn, 9);
    printf("Removing 9...\nThe bag's content: []\n");
    assertTrue(!containsDynArr(dyn, 9), "Test not containing 9");
    assertTrue(sizeDynArr(dyn) == 0, "Test size = 0");
    printf("Testing remove with empty stack...\n");
    removeDynArr(dyn, 1);

    addDynArr(dyn, 3);
    addDynArr(dyn, 4);
    addDynArr(dyn, 10);
    printf("\n\nThe array's content: [3,4,10]\n");
    popDynArr(dyn);
    printf("Popping...\nThe stack's content: [3,4]\n");
    popDynArr(dyn);
    printf("Popping...\nThe stack's content: [3]\n");
    popDynArr(dyn);
    printf("Popping...\nThe stack's content: []\n");
    assertTrue(sizeDynArr(dyn) == 0, "Test size = 0");
    printf("Testing pop with empty stack...\n");
    popDynArr(dyn);
	return 0;
}
